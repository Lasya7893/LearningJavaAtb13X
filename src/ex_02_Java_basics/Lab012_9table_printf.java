...
public class Lab012_9table_printf {
    public static void main(String[] args) {
        int a = 9; int b = 10;
        String f = "lasya"; String l = "C";
       /* System.out.println("The 9 table is as follows:");
        ...
        System.out.printf("%d x 11= %d.%n",a,a*11);
        System.out.printf("%d x 12= %d.%n",a,a*12);*/
        System.out.println((a+b+f+l));
    }
}
